...
In order to support loading of multiple wallets in axle-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is axle.cpp.
...
Changes to axle.cpp
----------------------
axle.cpp is the entry point into axle-qt, and as such, will require some minor modifications to provide hooks for
