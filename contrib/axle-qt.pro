...
RESOURCES += src/qt/axle.qrc src/qt/axle_locale.qrc

TRANSLATIONS += src/qt/locale/axle_bg.ts \
                src/qt/locale/axle_de.ts \
                src/qt/locale/axle_en.ts \
                src/qt/locale/axle_es.ts \
                src/qt/locale/axle_fi.ts \
                src/qt/locale/axle_fr.ts \
                src/qt/locale/axle_it.ts \
                src/qt/locale/axle_ja.ts \
                src/qt/locale/axle_pl.ts \
                src/qt/locale/axle_pt.ts \
                src/qt/locale/axle_ru.ts \
                src/qt/locale/axle_sk.ts \
                src/qt/locale/axle_sv.ts \
                src/qt/locale/axle_vi.ts \
                src/qt/locale/axle_zh_CN.ts \
                src/qt/locale/axle_zh_TW.ts
