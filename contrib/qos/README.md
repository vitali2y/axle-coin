...
This means one can have an always-on axled instance running, and another local axled/axle-qt instance which connects to this node and receives blocks from it.
