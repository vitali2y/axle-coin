...
The AXLE project operates an open contributor model where anyone is
...
The following applies to code changes to the AXLE project, and is not to be
confused with overall AXLE Network Protocol consensus changes.

Whether a pull request is merged into AXLE rests with the project merge
...
Patches that change AXLE consensus rules are considerably more involved than
...
Where a patch set proposes to change the AXLE consensus, it must have been
...
The project leader is the release manager for each AXLE release.
