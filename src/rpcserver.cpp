...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AXLE features */
        {"axle", "masternode", &masternode, true, true, false},
        {"axle", "listmasternodes", &listmasternodes, true, true, false},
        {"axle", "getmasternodecount", &getmasternodecount, true, true, false},
        {"axle", "masternodeconnect", &masternodeconnect, true, true, false},
        {"axle", "masternodecurrent", &masternodecurrent, true, true, false},
        {"axle", "masternodedebug", &masternodedebug, true, true, false},
        {"axle", "startmasternode", &startmasternode, true, true, false},
        {"axle", "createmasternodekey", &createmasternodekey, true, true, false},
        {"axle", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"axle", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"axle", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"axle", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"axle", "getmasternodescores", &getmasternodescores, true, true, false},
        {"axle", "mnbudget", &mnbudget, true, true, false},
        {"axle", "preparebudget", &preparebudget, true, true, false},
        {"axle", "submitbudget", &submitbudget, true, true, false},
        {"axle", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"axle", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"axle", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"axle", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"axle", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"axle", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"axle", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"axle", "checkbudgets", &checkbudgets, true, true, false},
        {"axle", "mnsync", &mnsync, true, true, false},
        {"axle", "spork", &spork, true, true, false},
        {"axle", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"axle", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> axle-cli " + methodname + " " + args + "\n";
}
