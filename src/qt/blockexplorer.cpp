...
{
    std::string genesisblockhash = "00000546ba134f98bbb5f8f317dd7e7c54c057456bea1e2614d4e6eba10073af";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (axle.conf).");
            QMessageBox::warning(this, "AXLE Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
