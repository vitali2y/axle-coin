...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AXLE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and axle: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAXLE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AXLE"), this);
    aboutAction->setStatusTip(tr("Show information about AXLE"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AXLE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AXLE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AXLE addresses"));
    ...
    openAction->setStatusTip(tr("Open a AXLE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AXLE help message to get a list with possible AXLE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AXLE client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AXLE network", "", count));
}
...
{
    QString strTitle = tr("AXLE"); // default title
