 ...
 */
    ...
    typeWidget->addItem(tr("Received Piv from zAXLE"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zAXLE"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zAXLE));
