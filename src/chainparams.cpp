...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 9009;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // AXLE starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // AXLE: 1 day
        nTargetSpacing = int64_t(2.5 * 60);  // AXLE: 2 minutes 30 seconds
        nMaturity = 100;
        ...
        // AXLE addresses start with 'S'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,63);
        // AXLE script addresses start with '3'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        // AXLE private keys start with '7' (uncompressed) or 'V' (compressed)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,191);
        // AXLE BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // AXLE BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // AXLE BIP44 coin type (pending BIP44-capable wallet, use Bitcoin type)
...
public:
    CTestNetParams()
    {
        ...
        bnProofOfWorkLimit = ~uint256(0) >> 1; // 0x207fffff, AXLE testnet starting difficulty
        nSubsidyHalvingInterval = 210240;
        nDefaultPort = 19009;
        ...
        // Testnet AXLE addresses start with 'm' or 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,111);
        // Testnet AXLE script addresses start with '2'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,196);
        // Testnet private keys start with '9' (uncompressed) or 'c' (compressed)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet AXLE BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet AXLE BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet AXLE BIP44 coin type is '1' (All coin's testnet default)
